...
/**
 * Created by huchengjie on 2018/1/4.
 */
...
public class MemberSideBar extends TextView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.MemberSideBar);
            scaleSize = ta.getInteger(R.styleable.MemberSideBar_scaleSize, 1);
            scaleItemCount = ta.getInteger(R.styleable.MemberSideBar_scaleItemCount, 6);
            scaleWidth = ta.getDimensionPixelSize(R.styleable.MemberSideBar_scaleWidth, dp(100));
            ta.recycle();
        }
