 ...
 */
public class ContactEaglesoftHolder extends BindedViewHolder {
    ...
    public ContactEaglesoftHolder(FrameLayout fl, boolean isSelectable, Context context, OnItemClickedListener<Contact> onItemClickedListener) {
        super(fl);
