...
public class MemberEaglesoftAdapter extends HolderAdapter<MentionFilterResult> {
    ...
    public MemberEaglesoftAdapter(int gid, Context context) {
        super(context);
    ...
    private class GroupViewHolder extends ViewHolder<MentionFilterResult> {
        ...
        public View init(final MentionFilterResult data, ViewGroup viewGroup, Context context) {
            View res = ((Activity) context).getLayoutInflater().inflate(R.layout.fragment_chat_member_eaglesoft_item, viewGroup, false);
