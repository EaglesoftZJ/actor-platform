...
public class ZzjgHolder  extends BindedViewHolder {
    ...
    public ZzjgHolder(FrameLayout fl, boolean isSelectable, Context context, OnItemClickedListener<Contact> onItemClickedListener) {
        super(fl);
