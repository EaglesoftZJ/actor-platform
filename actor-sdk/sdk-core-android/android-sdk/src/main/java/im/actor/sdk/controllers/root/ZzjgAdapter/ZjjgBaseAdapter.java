...
public abstract class ZjjgBaseAdapter<V extends BserObject & ListEngineItem,
    ...
    public ZjjgBaseAdapter(BindedDisplayList<V> displayList) {
        this(displayList, true);
    }

    public ZjjgBaseAdapter(BindedDisplayList<V> displayList, boolean autoConnect) {
