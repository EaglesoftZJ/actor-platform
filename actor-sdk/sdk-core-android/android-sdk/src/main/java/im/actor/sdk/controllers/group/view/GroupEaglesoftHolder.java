 ...
 */
public class GroupEaglesoftHolder extends BindedViewHolder {
    ...
    private OnItemClickedListener<GroupVM> onItemClickedListener;
    private final View separator;

    public GroupEaglesoftHolder(FrameLayout fl, boolean isSelectable, Context context, OnItemClickedListener<GroupVM> onItemClickedListener) {
        super(fl);
...
//            layoutParams.leftMargin = Screen.dp(40);
            layoutParams.leftMargin = Screen.dp(2);
        ...
        {
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(Screen.dp(2), ViewGroup.LayoutParams.MATCH_PARENT);
...
//        }
    ...
    public void bind(final GroupVM data, String shortName, String query, boolean selected, boolean isLast) {
...
//        fastTitle.setVisibility(View.GONE);
        ...
        if (query.length() > 0) {
            title.setText(SearchHighlight.highlightQuery(data.getName().get(), query, 0xff0277bd));
        } else {
