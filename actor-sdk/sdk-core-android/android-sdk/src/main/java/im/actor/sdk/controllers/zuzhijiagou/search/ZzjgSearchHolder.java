...
public class ZzjgSearchHolder extends BindedViewHolder {

    private AvatarView avatar;
    private TextView title;
    private View separator;
    private ZzjgSearchEntity entity;

    private int highlightColor;

    public ZzjgSearchHolder(Context context, final OnItemClickedListener<ZzjgSearchEntity> clickedListener) {
        super(new FrameLayout(context));
        init(context, clickedListener);
    }

    protected void init(Context context, final OnItemClickedListener<ZzjgSearchEntity> clickedListener) {
